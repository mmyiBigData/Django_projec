...
class Element(models.Model):
    elemt = models.CharField(max_length=8, blank=True, null=True)
...
class Sname(models.Model):
    ...
    dateu = models.CharField(db_column='dateU', max_length=30, blank=True, null=True)  # Field name made lowercase.
...
class Post(models.Model):
	...
	# def publish(self):
		# self.publish_date=timezone.now(default=timezone.now)
		# self.save()
